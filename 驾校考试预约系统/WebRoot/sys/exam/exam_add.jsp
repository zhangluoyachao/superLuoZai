...
<body>
	...
	<table width="99%" border="0" cellspacing="0" cellpadding="0"
		id="searchmain">
		<tr>
			<td width="99%" align="left" valign="top">您的位置：考试管理&nbsp;&nbsp;>&nbsp;&nbsp;添加考试</td>
		</tr>
		<tr>
		...
		<tr>
			<td align="left" valign="top">
				<form action="exam_list.jsp" enctype="multipart/form-data"
					method="post">
					<table width="100%" border="0" cellspacing="0" cellpadding="0"
						...
						<tr onMouseOut="this.style.backgroundColor='#ffffff'"
							...
							<td align="left" valign="middle"
								...
								type="text" id="time" name="time" class="s_text text-word"
								style="width:160px;"
						...
						<tr onMouseOut="this.style.backgroundColor='#ffffff'"
							...
							<td align="left" valign="middle"
								class="borderright borderbottom main-for"><input
								type="text" name="number" class="text-word"></td>
						</tr>
						<tr onMouseOut="this.style.backgroundColor='#ffffff'"
							onMouseOver="this.style.backgroundColor='#edf5ff'">
							<td align="right" valign="middle"
							...
							<td align="left" valign="middle"
								...
								name="" type="reset" value="重置" class="text-but"> <input
